const CACHE_NAME='materialnachweis-preise-v1-56-full';
const ASSETS=["./", "./index.html", "./preise.html", "./manifest.json", "./icon-192.png", "./icon-512.png", "./apple-touch-icon.png", "./logo-wappen.png", "./logo-ehringshausen.png"];
